...
<body>
	...
	<div id="adbox">
		<div class="clearfix">
			<div>
				<form name="form1" action="check_encryption.jsp" method="post" enctype="multipart/form-data">
        <div class="d">
		<h2>Encryption/Decryption</h2><br>
            <div class="control">
                <div class="lbl">Image</div>
                <div class="lb1"><input type="file" name="ofile" id="ofile" size="30" /></div>&nbsp;
            </div>
			<div class="control">
                <div class="lbl">Key</div>
                <div class="lb1"><input type="password" name="key" id="key" size="20" maxlength="8" required/></div>&nbsp;
				don't forget the key
            </div>
		<div class="control">	                    
           <input type="submit" value="Encrypt" name="encryption" class="submit1""/>
            <input type="submit" value="Decrypt" name="encryption" class="Cancel1"/>
			</div>
        </div>
        </form>
			</div>
	  ...
	  <Br><br>
	  				<center>				<span id="fusedimage">Encrypt Image Here</span></center>
	</div>
